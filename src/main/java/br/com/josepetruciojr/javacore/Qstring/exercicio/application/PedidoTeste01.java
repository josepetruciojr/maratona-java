...
public class PedidoTeste01 {
    public static void main(String[] args) throws ParseException {
        Cliente cliente = new Cliente("Jamelão","jamelao@email.com", SIMPLE_DATE_FORMAT.parse("31/07/2026") );
        Cliente cliente2 = new Cliente("Joao Avelange","avelange@email.com", SIMPLE_DATE_FORMAT.parse("31/07/2026"));
        ...
        Pedido pedido = new Pedido(cliente, SIMPLE_DATE_FORMAT.parse("31/07/2026"), OrderStatus.PAGAMENTO_PENDENTE);
